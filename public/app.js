...
const optionalExtras = [
  ...
  { id: 'youngDriverFee', name: 'Young Driver Fee', zhName: 'Young Driver Fee', dailyRate: 25, defaultQty: 1 },
  { id: 'iceBucket', name: 'Ice Bucket', zhName: '冰桶', dailyRate: 10, defaultQty: 1, maxTotal: 50 },
  { id: 'glassInsurance', name: 'Glass insurance', zhName: '玻璃保险', dailyRate: 8, defaultQty: 1, maxTotal: 200 }
];
...
function renderInsurancePanel() {
  ...
  `;
  insurancePanel.onchange = () => {
    syncExtrasForInsurance();
    updateExtrasTotals();
  };
}
